...
class ConfigX(object):
    ...
    def __init__(self):
        ...
        # Dataset Parameters
        self.dataset_name = ""  # short name of datasets ["ft":"filmtrust","db":"douban","ca":"ciao"]
        self.k_fold_num = 5  # the num of cross validation
        self.rating_path = "" #% self.dataset_name  # the raw ratings data file
        self.rating_cv_path = ""  # the cross validation file of ratings data
        self.trust_path = '' #% self.dataset_name  # the raw trust data file
        self.strust_path = ''
        ...
        self.coldUserRating = 4  # the number of ratings a cold start user rated on items
